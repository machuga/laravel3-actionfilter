...
class Filter_Controller extends \Controller
{
	...
	{
		return $this->before_filters[] = new Filter($callback);
	}

	protected function after_filter($callback)
	{
		return $this->after_filters[] = new Filter($callback);
	}
	...
	// This method will function like Laravel's filters and force a 404 if 
	// anything but null is returned
